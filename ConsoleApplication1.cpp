...
void AntivirusMultimap_init() {
	AntivirusMultimap = { 
		...
		{"MsMpEng.exe","Windows Defender防病毒服务(Windwos系统自带)"},
		{"MpDefenderCoreService.exe","Windows Defender防病毒核心服务(Windwos系统自带)"},
		{"NisSrv.exe","Windows Defender防病毒网络实时检查服务(Windwos系统自带)"},
		{"MpCmdRun.exe","Windows Defender防病毒命令行实用工具(Windwos系统自带)"},
		{"SBAMSvc.exe","VIPRE"},
		{"ccSvcHst.exe","Norton杀毒"},
		{"f-secure.exe","冰岛"},
		{"avp.exe","卡巴斯基 Kaspersky Lab launcher"},
		{"avpui.exe","卡巴斯基 Kaspersky Anti-Virus"},
		{"KvMonXP.exe","江民杀毒"},
		{"RavMonD.exe","瑞星杀毒"},
		{"Mcshield.exe","麦咖啡"},
		{"egui.exe","NOD32"},
